  ...
  if (loading) {
    return (
      <LoadingState
        ...
        description="We are gathering the latest platform metrics."
      />
    );
  }
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-5 gap-6">
        ...
        <div className="bg-white rounded-2xl shadow p-6 border">
          <div className="flex justify-between items-center">
            ...
            <BriefcaseBusiness size={40} className="text-green-500" />
          </div>
        </div>
        ...
        <div className="bg-white rounded-2xl shadow p-6 border">
          <div className="flex justify-between items-center">
            <div>
              ...
              <h2 className="text-3xl font-bold mt-2">{dashboard.totalJobs}</h2>
            </div>
        ...
        <div className="bg-white rounded-2xl shadow p-6 border">
          <div className="flex justify-between items-center">
            ...
            <ClipboardList size={40} className="text-red-500" />
          </div>
        </div>
      </div>
    </div>
